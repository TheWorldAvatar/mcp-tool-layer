...
`Sonicate`, `Transfer`, `Separate`, `Filter`, or `Dry`. There is no
`Crystallize` class; a crystal-yielding hold is `HeatChill`.
...
- duration, target/stirring/drying/evaporation temperature,
