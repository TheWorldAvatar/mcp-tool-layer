...
ontospecies:NoOntosynFormulaLiteralShape a sh:NodeShape ;
  sh:targetClass ontospecies:Species ;
  sh:sparql [
    sh:message "Put formula on ontospecies:ChemicalFormula / MolecularFormula nodes, not ontosyn literals" ;
    sh:select '''
      PREFIX ontosyn: <https://www.theworldavatar.com/kg/OntoSyn/>
      PREFIX ontospecies: <http://www.theworldavatar.com/ontology/ontospecies/OntoSpecies.owl#>
      SELECT $this
      WHERE {
        $this ontosyn:hasChemicalFormula ?lit .
        FILTER(isLiteral(?lit))
      }
    '''
  ] .

ontospecies:FormulaNodeMustHaveValueShape a sh:NodeShape ;
  sh:targetClass ontospecies:ChemicalFormula ;
  sh:sparql [
    sh:message "ChemicalFormula must carry hasChemicalFormulaValue" ;
    sh:select '''
      PREFIX ontospecies: <http://www.theworldavatar.com/ontology/ontospecies/OntoSpecies.owl#>
      SELECT $this
      WHERE {
        FILTER NOT EXISTS { $this ontospecies:hasChemicalFormulaValue ?v . }
      }
    '''
  ] .

ontospecies:MolecularFormulaNodeMustHaveValueShape a sh:NodeShape ;
  sh:targetClass ontospecies:MolecularFormula ;
  sh:sparql [
    sh:message "MolecularFormula must carry hasMolecularFormulaValue" ;
    sh:select '''
      PREFIX ontospecies: <http://www.theworldavatar.com/ontology/ontospecies/OntoSpecies.owl#>
      SELECT $this
      WHERE {
        FILTER NOT EXISTS { $this ontospecies:hasMolecularFormulaValue ?v . }
      }
    '''
  ] .

ontospecies:CCDCNumberNodeMustHaveValueShape a sh:NodeShape ;
  sh:targetClass ontospecies:CCDCNumber ;
  sh:sparql [
    sh:message "CCDCNumber must carry hasCCDCNumberValue" ;
    sh:select '''
      PREFIX ontospecies: <http://www.theworldavatar.com/ontology/ontospecies/OntoSpecies.owl#>
      SELECT $this
      WHERE {
        FILTER NOT EXISTS { $this ontospecies:hasCCDCNumberValue ?v . }
      }
    '''
  ] .
"""
