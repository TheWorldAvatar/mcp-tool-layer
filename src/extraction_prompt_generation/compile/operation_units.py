...
Each unit is one public create/add/check tool plus its required edges.
No GPT-5 call. See compile/README.md.
"""
...
def owned_entity_tool_contracts(context: Any) -> list[dict[str, Any]]:
