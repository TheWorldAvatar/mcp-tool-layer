"""Bind scheduling intent to the active T-Box semantic surface.

Planning assigns class and object-property ownership to profile slots.
This module checks those assignments against the parsed T-Box, infers
linked materialization classes, and attaches each slot's property closure.
It does not call GPT-5.
