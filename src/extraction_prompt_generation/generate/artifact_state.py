...
The state file is independent from the validation report. Reports describe
the latest validation result; this journal records where generation stopped
so an interrupted process can resume without guessing from file size.
