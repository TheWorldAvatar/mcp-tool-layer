"""Assign primary-T-Box classes and object properties to fixed profile slots.

No LLM call. Complex profiles split foundation / ordered / remainder from
T-Box ranges and the ordered-member profile. Simple profiles put the whole
downstream surface on one slot.
