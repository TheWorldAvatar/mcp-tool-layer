"""Parse OWL/RDF Turtle into the class/property maps used by compile.

Extracts classes and parents, datatype/object properties with domain and
range, and the per-class applicable-property index. Private pipeline
annotation predicates are not read; operational policy lives in comments,
contracts, or domain config.
