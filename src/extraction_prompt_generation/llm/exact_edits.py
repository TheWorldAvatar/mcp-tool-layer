...
The model proposes structured replacements; this module applies them and
re-validates. There is no whole-file rewrite path. See llm/README.md.
"""
...
from src.extraction_prompt_generation.llm.editor_retry import (
