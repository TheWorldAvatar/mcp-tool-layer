"""Batch-warm OntoSpecies uses corpus."""
...
from mini_marie.marie.chemistry.species_uses_corpus import (
    DEFAULT_BATCH_SIZE,
    SpeciesUsesCorpusStore,
    count_species_with_uses_remote,
    warm_uses_corpus,
)


def main() -> None:
    parser = argparse.ArgumentParser(description="Warm OntoSpecies uses corpus")
