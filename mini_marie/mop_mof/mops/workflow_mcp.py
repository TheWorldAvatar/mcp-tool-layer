"""MCP-safe MOPs TWA workflow execution (compact agent responses, full data on disk)."""
...
from mini_marie.mop_mof.mops.twa_operations import format_results_as_tsv
from mini_marie.mop_mof.mops.workflow_engine import (
