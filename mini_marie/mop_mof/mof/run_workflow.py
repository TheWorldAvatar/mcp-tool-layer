"""Run a MOF workflow online (limited SPARQL) and record the call trace for offline replay."""
...
from mini_marie.mop_mof.mof.workflow_engine import load_workflow, run_workflow, save_run


def main() -> None:
    parser = argparse.ArgumentParser(description="Run MOF TWA workflow (online probe + record)")
